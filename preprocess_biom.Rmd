...
```{r}
# Combine all elements in a list into a data frame, merging by both IDs. Time consuming
...
```{r}
# Combine all elements in a list into a data frame, merging by ID only. Time consuming
